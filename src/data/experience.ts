...
export const experiences: Experience[] = [
  {
    ...
    current: true,
    description:
      'Ingresé como desarrollador y crecí a líder de un equipo de 7 personas. Por movimientos internos regresé al rol de full stack, colaborando activamente en el equipo con propuestas de arquitectura, mejoras de proceso y revisión de código.',
    achievements: [
      'Coordiné un equipo de 7 desarrolladores: planeación de sprints, code reviews y acompañamiento técnico',
      'Colaboré con el equipo en el desarrollo de una suite empresarial: asistencias, usuarios, catálogos, plazas y expedientes',
      'Participé en el diseño e implementación del módulo de contratos electrónicos con firma digital',
      'Contribuí al sistema de reclutamiento con flujos de aprobación y motor de campañas',
      'Aporté soluciones de arquitectura, estándares de calidad de código y mejoras continuas al equipo',
    ],
